...
arch=('x86_64')
url="https://github.com/minhcopilot/cursor-reset-id"
...
source=("cursor-free-vip::git+https://github.com/minhcopilot/cursor-reset-id.git" "https://raw.githubusercontent.com/canmi21/openjlc/refs/heads/main/LICENSE")
